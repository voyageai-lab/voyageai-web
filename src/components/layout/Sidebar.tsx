    ...
    <div className="w-72 bg-gray-900 text-gray-100 flex flex-col h-full">
      ...
      <div className="px-3 mb-1">
        <button
          ...
          className="w-full flex items-center gap-2 px-4 py-2 rounded-lg text-gray-300 hover:bg-gray-800 transition text-sm"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex-1 overflow-y-auto px-2 space-y-0.5">
        ...
        {projects.map((project) => {
          const isCollab = project.role && project.role !== 'OWNER';
          return (
            <button
            ...
            >
              ...
              <div className="truncate flex-1">
                ...
                {isCollab && project.ownerDisplayName && (
                  <span className="text-[10px] text-gray-500 truncate block">
                    by {project.ownerDisplayName} · {project.role}
                  </span>
                )}
              </div>
              {!isCollab && (
